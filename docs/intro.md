...
![High-level architecture](assets/c2-diagram.svg)

The collection includes:

* infinvis-rate-service – collects and manages exchange rates.
* infinvis-operation-service – manages income and expense operations and provides basic manipulations on them.